...
export const metadata: Metadata = {
  ...
  description:
    "Velto outlets in Uttara Sector 11 and Sector 18, with pickup and delivery across Uttara Sectors 1–18.",
};
...
export default function LocationsPage() {
  return (
    <>
      ...
      <section aria-label="Outlets" className="bg-warm py-(--space-section)">
